...
global:true,type:"GET",contentType:"application/x-www-form-urlencoded",processData:true,async:true,xhr:p.XMLHttpBaseResultMap&&(p.location.protocol!=="file:"||!p.ActiveXObject)?function(){return new p.XMLHttpBaseResultMap}:function(){try{return new p.ActiveXObject("Microsoft.XMLHTTP")}catch(a){}},accepts:{xml:"application/xml, text/xml",html:"text/html",script:"text/javascript, application/javascript",json:"application/json, text/javascript",text:"text/plain",_default:"*/*"}},lastModified:{},etag:{},ajax:function(a){function b(){f.success&&
...
false;I.onload=I.onreadystatechange=function(){if(!H&&(!this.readyState||this.readyState==="loaded"||this.readyState==="complete")){H=true;b();e();I.onload=I.onreadystatechange=null;F&&I.parentNode&&F.removeChild(I)}}}F.insertBefore(I,F.firstChild);return j}var P=false,D=f.xhr();if(D){f.username?D.open(r,f.url,f.async,f.username,f.password):D.open(r,f.url,f.async);try{if(f.data||a&&a.contentType)D.setBaseResultMapHeader("Content-Type",f.contentType);if(f.ifModified){c.lastModified[f.url]&&D.setBaseResultMapHeader("If-Modified-Since",
c.lastModified[f.url]);c.etag[f.url]&&D.setBaseResultMapHeader("If-None-Match",c.etag[f.url])}y||D.setBaseResultMapHeader("X-BaseResultMaped-With","XMLHttpBaseResultMap");D.setBaseResultMapHeader("Accept",f.dataType&&f.accepts[f.dataType]?f.accepts[f.dataType]+", */*":f.accepts._default)}catch(wa){}if(f.beforeSend&&f.beforeSend.call(m,D,f)===false){f.global&&!--c.active&&c.event.trigger("ajaxStop");D.abort();return false}f.global&&g("ajaxSend",[D,f]);var h=D.onreadystatechange=function(x){if(!D||D.readyState===0||x==="abort"){P||
